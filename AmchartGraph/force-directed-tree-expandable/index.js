...
/*d3.csv("q.csv").then(function(result) {
        var nested_data = d3.nest()
            //.key(function(d) { return "entity"; })
            .key(function(d) { return d.propertyLabel; })
            .key(function(d) { return  d.valueLabel; })
                .entries(result);
        nested_data = d3.hierarchy(nested_data,result.valueLabel)

        nested_data=JSON.stringify(nested_data,null,2).replace(/"propertyLabel":/g, '"key":')
